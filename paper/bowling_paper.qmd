...
![Sequence sensitivity: four orderings of the same 5-strike, 4-spare composition. Traditional scores vary; World Bowling scores are identical.](../figures/fig5_sequence_sensitivity.pdf){#fig-sequence width=100%}
...
![Left: total game score as a function of consecutive strikes from frame 1. Right: marginal value of each additional strike. Traditional scoring is super-linear; World Bowling is flat at +21.](../figures/fig3_reward_gradient.pdf){#fig-gradient width=100%}
